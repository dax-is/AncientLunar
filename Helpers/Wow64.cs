...
namespace AncientLunar.Helpers
{
    internal static unsafe class Wow64
    {
        ...
        private static readonly byte[] getteb64 = {
        ...
        private static readonly byte[] createthread64 = {
        ...
        private static readonly byte[] execute64 = {
        ...
        public static IEnumerable<ModuleInfo> EnumModules(Process process, ulong pebAddress)
        {
            ...
            var firstEntry = peb.LoaderData + 0x10;
